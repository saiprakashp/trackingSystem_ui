...
class ProjectWiseUtilization extends Component {
    state = {
        supervisor: [{title: 'Sai Prakash', id: 1},
            {title: 'Santosh', id: 4}, {title: 'Sudhakar', id: 2}, {title: 'Naidu', id: 3},],
        products: [{title: 'All', id: 1}, {title: 'Direct', id: 1}],
        application: [{title: 'All', id: 1}, {title: 'Direct', id: 1}],
        project: [{title: 'All', id: 1}, {title: 'Direct', id: 1}],
        errorMessage: null,
            ...
            <div className="container bg-white">
                ...
                <div className="row pl-4 ml-1">
                    <div className="col-sm-3 ml-2">
                        {(this.state.supervisor != null) ? UseAutocomplete({
                    ...
                    <div className="col-sm-3 ml-2 ">
                        {(this.state.products != null) ? UseAutocomplete({
                            title: title.PRODUCT,
                            ref: this.products,
                            classes: 't-b mr-1',
                    ...
                    <div className="col-sm-3 ml-2 ">
                        {(this.state.application != null) ? UseAutocomplete({
                ...
                <div className="row mt-2 ml-4">
                    ...
                    <div className="col-sm-3  ml-2">
                        {(this.state.project != null) ? UseAutocomplete({
                            title: title.PROJECT,
                            ref: this.project,
                            classes: 't-b mr-1',
...
export default ProjectWiseUtilization;
